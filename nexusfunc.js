...
async function fetchCourses() {
  ...
  const response = await fetch('https://elbert-api-prod.azurewebsites.net/api/readonly/courses/NEXus - The Nursing Education Xchange');
...
function displayCoursesWithoutPagination(courses) {
    ...
    courses.forEach(course => {
        ...
        courseLink.href = `/coursedetailsnexus?courseCode=${encodeURIComponent(course.code)}&providerName=${encodeURIComponent(course.providerName)}`;
